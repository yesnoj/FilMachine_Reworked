...
lv_obj_set_height( ui_PanelScreenSettingVolumeSwitch, 100);
lv_obj_set_width( ui_PanelScreenSettingVolumeSwitch, lv_pct(90));
lv_obj_set_x( ui_PanelScreenSettingVolumeSwitch, 20 );
...
lv_obj_set_style_text_font(ui_LabelPanelScreenSettingVolumeSwitch, &lv_font_montserrat_24, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_SliderPanelScreenSettingVolumeSwitch = lv_slider_create(ui_PanelScreenSettingVolumeSwitch);
lv_obj_set_width( ui_SliderPanelScreenSettingVolumeSwitch, 200);
lv_obj_set_height( ui_SliderPanelScreenSettingVolumeSwitch, 15);
lv_obj_set_x( ui_SliderPanelScreenSettingVolumeSwitch, 50 );
...
ui_SpinnerScreenSettingVolume = lv_spinner_create(ui_ScreenSettingVolume,400,90);
