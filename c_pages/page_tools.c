...
static void initTools_maintenance(lv_obj_t *parent) {
  ...
  lv_obj_set_size(gui.page.tools.toolsCleaningContainer, ui->item_row_w, ui->action_row_h);
  ...
  lv_obj_align(gui.page.tools.toolsDrainingContainer, LV_ALIGN_TOP_LEFT, ui->item_row_x, ui->maintenance_drain_y);
  lv_obj_set_size(gui.page.tools.toolsDrainingContainer, ui->item_row_w, ui->action_row_h);
  ...
  lv_obj_align(gui.page.tools.toolsSelfcheckContainer, LV_ALIGN_TOP_LEFT, ui->item_row_x, ui->maintenance_selfcheck_y);
  lv_obj_set_size(gui.page.tools.toolsSelfcheckContainer, ui->item_row_w, ui->action_row_h);
...
static void initTools_utilities(lv_obj_t *parent) {
  ...
  lv_obj_set_size(gui.page.tools.toolsImportContainer, ui->item_row_w, ui->action_row_h);
  ...
  lv_obj_align(gui.page.tools.toolsExportContainer, LV_ALIGN_TOP_LEFT, ui->item_row_x, ui->utilities_export_y);
  lv_obj_set_size(gui.page.tools.toolsExportContainer, ui->item_row_w, ui->action_row_h);
...
static void initTools_statistics(lv_obj_t *parent) {
  ...
  lv_obj_set_size(gui.page.tools.toolsStatCompleteProcessesContainer, ui->item_row_w, ui->stat_row_h);
  ...
  lv_obj_set_size(gui.page.tools.toolsStatTotalTimeContainer, ui->item_row_w, ui->stat_row_h);
  ...
  lv_obj_set_size(gui.page.tools.toolsStatCompleteCycleContainer, ui->item_row_w, ui->stat_row_h);
  ...
  lv_obj_set_size(gui.page.tools.toolsStatStoppedProcessesContainer, ui->item_row_w, ui->stat_row_h);
...
static void initTools_software(lv_obj_t *parent) {
  ...
  lv_obj_set_size(gui.page.tools.toolsSoftwareVersionContainer, ui->item_row_w, ui->stat_row_h);
  ...
  lv_obj_set_size(gui.page.tools.toolsSoftwareSerialContainer, ui->item_row_w, ui->stat_row_h);
...
static void initTools_update(lv_obj_t *parent) {
  ...
  lv_obj_align(gui.page.tools.toolsUpdateContainer, LV_ALIGN_TOP_LEFT, ui->item_row_x, ui->update_sd_y);
  lv_obj_set_size(gui.page.tools.toolsUpdateContainer, ui->item_row_w, ui->action_row_h);
  ...
  lv_obj_align(gui.page.tools.toolsUpdateWifiContainer, LV_ALIGN_TOP_LEFT, ui->item_row_x, ui->update_wifi_y);
  lv_obj_set_size(gui.page.tools.toolsUpdateWifiContainer, ui->item_row_w, ui->action_row_h);
