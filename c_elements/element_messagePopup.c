...
//                lv_obj_delete(mboxCont);  // Not required! Can cause crash!
            ...
            else if (gui.element.messagePopup.whoCallMe == gui.tempStepNode && gui.tempStepNode->step.swipedLeft == false)
            {
            ...
            else if (gui.element.messagePopup.whoCallMe == gui.tempStepNode && gui.tempStepNode->step.swipedLeft == true)
            {
            ...
            else if (gui.tempProcessNode != NULL && gui.element.messagePopup.whoCallMe == gui.tempProcessNode->process.processDetails->checkup->checkupStopNowButton)
            {
            ...
            else if (gui.tempProcessNode != NULL && gui.element.messagePopup.whoCallMe == gui.tempProcessNode->process.processDetails->checkup->checkupStopAfterButton)
            {
                        ...
                        || gui.element.messagePopup.whoCallMe == gui.tempProcessNode->process.processDetails->checkup->checkupStopNowButton)))
            {
                ...
                if(gui.element.messagePopup.whoCallMe == gui.tempStepNode && gui.tempStepNode->step.swipedLeft == true && gui.tempStepNode->step.swipedRight == false){
                    ...
                    if (newStep == NULL) {
                        ...
                        memcpy(newStep->step.stepDetails, gui.tempStepNode->step.stepDetails, sizeof(sStepDetail));
