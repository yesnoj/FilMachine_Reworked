...
cp "$REPO/drivers/"*.c                 "$NEW/drivers/"
cp "$REPO/drivers/include/"*.h         "$NEW/drivers/include/"
...
echo "  cp -r main/ c_pages/ c_elements/ c_fonts/ drivers/ \\"
echo "     $REPO/"
